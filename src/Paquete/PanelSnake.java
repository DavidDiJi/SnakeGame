...
public class PanelSnake extends JPanel {
    ...
    //metodo que genera el movimiento hacia a delante de la serpiente
    public void avanzar(){
     igualardir();   
     ...
     int agregary=0;
      ...
      switch(direccion){
       ...
       for(int i = 0; i < snake.size(); i++){
        ...
        if (existe) {
            JOptionPane.showMessageDialog(this, "has Pedido");
        }else{
    ...
    //metodo que cambia de dirección
